...
public class PrepFabForm extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prepfab_form);
        ...
        getSupportActionBar().setTitle((CharSequence) getIntent().getSerializableExtra("judul"));
    }
